...
Definición en la línea 10 del archivo pro2.\-cc.


\begin{DoxyCode}
11 \{
12     \hyperlink{class_comanda}{Comanda} c;
13     \hyperlink{class_agenda}{Agenda} a;
14     \textcolor{keywordtype}{bool} be = \textcolor{keyword}{false};
15     map<Reloj,Tarea> v;
16     \textcolor{keywordflow}{while}(c.\hyperlink{class_comanda_af2dbc8ccdbb94bed6ea26155edc71b57}{llegir}(be))\{
17         \textcolor{keywordtype}{bool} todo\_OK = \textcolor{keyword}{true};
18         \textcolor{keywordflow}{if}(be)\{
19             \textcolor{keywordflow}{if}(c.\hyperlink{class_comanda_a847ee227fd7fea3a105dbd78735de453}{es\_consulta}())\{
20                 \hyperlink{class_reloj}{Reloj} r(\textcolor{stringliteral}{"00/00/00"},\textcolor{stringliteral}{"00:00"});
21                 \hyperlink{class_reloj}{Reloj} r2(\textcolor{stringliteral}{"31/12/99"},\textcolor{stringliteral}{"23:59"});
22                 \textcolor{keywordtype}{string} expr = \textcolor{stringliteral}{"*"};
...
27                         \textcolor{keywordflow}{if}(c.\hyperlink{class_comanda_aadabfc85ec7cdeb45039e8952a1ab124}{nombre\_dates}() == 2) r2.\hyperlink{class_reloj_af996940ee33d23f3d592b96338210f3b}{modificar\_fecha}(c.
...
29                             r.modificar\_hora(c.\hyperlink{class_comanda_ae8bca2ad702d3316dc1c53dcab7cac02}{hora}());
30                             r2.modificar\_hora(c.\hyperlink{class_comanda_ae8bca2ad702d3316dc1c53dcab7cac02}{hora}());
31                         \} \textcolor{keywordflow}{else} \{
32                             r.modificar\_hora(\textcolor{stringliteral}{"00:00"});
33                             r2.modificar\_hora(\textcolor{stringliteral}{"23:59"});
34                         \}
35                     \}
...
48                 advance(it,tasca); \textcolor{comment}{// selecionamos la tarea}
...
56                     r2.\hyperlink{class_reloj_ac19961f7455f4e255fe4ef7fa809ceb1}{modificar\_hora}(c.\hyperlink{class_comanda_ae8bca2ad702d3316dc1c53dcab7cac02}{hora}());
57                 \}
58                 \textcolor{keywordflow}{if}(c.\hyperlink{class_comanda_aadabfc85ec7cdeb45039e8952a1ab124}{nombre\_dates}() != 0)\{
59                     r2.\hyperlink{class_reloj_af996940ee33d23f3d592b96338210f3b}{modificar\_fecha}(c.\hyperlink{class_comanda_ab4ce0a50bde32145d11cbaee753526c7}{data}(1));
60                 \}
...
67                     r.\hyperlink{class_reloj_af996940ee33d23f3d592b96338210f3b}{modificar\_fecha}(c.\hyperlink{class_comanda_ab4ce0a50bde32145d11cbaee753526c7}{data}(1));
68                 \} \textcolor{keywordflow}{else} \{
69                     r = a.\hyperlink{class_agenda_afc5f9ca9546ff0000e4abe92584ac526}{consultar\_RelojActual}();
70                 \}
71                 r.\hyperlink{class_reloj_ac19961f7455f4e255fe4ef7fa809ceb1}{modificar\_hora}(c.\hyperlink{class_comanda_ae8bca2ad702d3316dc1c53dcab7cac02}{hora}());
...
86                     \textcolor{keywordflow}{if}(c.\hyperlink{class_comanda_abf8b926146f3664aacfd24d7800014e5}{te\_hora}()) r.\hyperlink{class_reloj_ac19961f7455f4e255fe4ef7fa809ceb1}{modificar\_hora}(c.\hyperlink{class_comanda_ae8bca2ad702d3316dc1c53dcab7cac02}{hora}());
87                     \textcolor{keywordflow}{if}(c.\hyperlink{class_comanda_aadabfc85ec7cdeb45039e8952a1ab124}{nombre\_dates}() != 0) r.\hyperlink{class_reloj_af996940ee33d23f3d592b96338210f3b}{modificar\_fecha}(c.
      \hyperlink{class_comanda_ab4ce0a50bde32145d11cbaee753526c7}{data}(1));
88                     todo\_OK = a.\hyperlink{class_agenda_a3c6df651d375edc2f3c2f06103eefd8b}{modificar\_RelojActual}(r);
89                 \} \textcolor{keywordflow}{else} \{ \textcolor{comment}{// caso consulta}
90                     r = a.\hyperlink{class_agenda_afc5f9ca9546ff0000e4abe92584ac526}{consultar\_RelojActual}();
91                     cout << r.\hyperlink{class_reloj_a3031e0e51df831ecebc72af577a745e6}{consultar\_fecha}() << \textcolor{stringliteral}{"   "} << r.
      \hyperlink{class_reloj_aedc980bf42354252bf50712f560981e5}{consultar\_hora}() << endl;
92                 \}
...
95                 \hyperlink{class_reloj}{Reloj} reloj2 = a.\hyperlink{class_agenda_afc5f9ca9546ff0000e4abe92584ac526}{consultar\_RelojActual}();
96                 \textcolor{keywordtype}{string} expr = \textcolor{stringliteral}{"*"};
...
105                 advance(it,tasca); \textcolor{comment}{// selecionamos la tarea}
...
115                     t.\hyperlink{class_tarea_a302eed4ef2367fcbc10c9fbc98a291ad}{borar\_tag}(c.\hyperlink{class_comanda_ac80e9a80d16c6bac9a134e431bca1ed0}{etiqueta}(1));
